Public Class frmAddWizardSpells
    Public intWizardLevel As Integer
    Private Sub frmAddWizardSpells_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
